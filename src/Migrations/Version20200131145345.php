 ...
 */
final class Version20200131145345 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE animateur ADD email_contact VARCHAR(100) NOT NULL, ADD telephone_contact VARCHAR(100) NOT NULL, ADD notes VARCHAR(255) DEFAULT NULL, ADD documentation_disponible VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE animateur DROP email_contact, DROP telephone_contact, DROP notes, DROP documentation_disponible');
    }
}
